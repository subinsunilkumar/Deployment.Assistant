      ...
      <body>
        ...
        <table style="width:100%;" valign="top">
          <tr>
            ...
            <td style="width:50%;">
              <table>
                  <xsl:for-each select="Report/section[(title = 'Patient Information') or (title = 'MDT Information')]">
                    <tr width="98%">
            ...
            <td >
              <div style="padding-left:20px">
                <table style="border:1pt solid black !important;">
                  <xsl:for-each select="Report/section[(title != 'Patient Information') and (title != 'MDT Information')]">
                    <tr width="98%">
                        <td class="report-header">
